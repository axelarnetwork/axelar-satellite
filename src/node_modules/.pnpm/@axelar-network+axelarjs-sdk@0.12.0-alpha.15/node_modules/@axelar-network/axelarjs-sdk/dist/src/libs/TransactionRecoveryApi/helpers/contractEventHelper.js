...
function getLogIndexFromTxReceipt(receipt) {
    var _a, _b;
    return (((_a = getContractCallEvent(receipt)) === null || _a === void 0 ? void 0 : _a.logIndex) || ((_b = getContractCallWithTokenEvent(receipt)) === null || _b === void 0 ? void 0 : _b.logIndex));
}
