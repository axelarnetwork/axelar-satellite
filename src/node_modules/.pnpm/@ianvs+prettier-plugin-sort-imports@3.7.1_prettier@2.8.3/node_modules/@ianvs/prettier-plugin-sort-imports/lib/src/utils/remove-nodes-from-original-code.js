...
function compareRangesByStart(range1, range2) {
...
function mergeRanges(ranges) {
    ...
    for (var _i = 0, ranges_1 = ranges; _i < ranges_1.length; _i++) {
        ...
        var currRange = merged[merged.length - 1];
 ...
 */
function invertRanges(ranges, totalLength) {
    ...
    var resultRanges = [];
    var isValidRange = function (start, end) { return end > start; };
    ...
    //                 ^---^    ^----^
    //                   These parts
    for (var index = 0; index < ranges.length - 1; index += 1) {
        var prevRange = ranges[index];
        var nextRange = ranges[index + 1];
        var start = prevRange[1];
        var end = nextRange[0];
