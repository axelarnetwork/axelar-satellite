...
export declare function createTxMsgUpdateRevenue(chain: Chain, sender: Sender, fee: Fee, memo: string, params: MessageMsgUpdateRevenue): {
    signDirect: {
...
//# sourceMappingURL=msgUpdateRevenue.d.ts.map