...
export declare function createTxMsgConvertERC20(chain: Chain, sender: Sender, fee: Fee, memo: string, params: MessageMsgConvertERC20): {
    signDirect: {
...
//# sourceMappingURL=msgConvertERC20.d.ts.map