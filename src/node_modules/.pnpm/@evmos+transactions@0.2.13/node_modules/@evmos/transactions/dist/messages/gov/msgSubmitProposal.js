...
exports.createTxMsgSubmitProposal = void 0;
const proto_1 = require("@evmos/proto");
const eip712_1 = require("@evmos/eip712");
function createTxMsgSubmitProposal(chain, sender, fee, memo, params) {
    ...
    const msg = (0, eip712_1.createMsgSubmitProposal)(params.content, params.initialDepositDenom, params.initialDepositAmount, sender.accountAddress);
    ...
    const msgCosmos = (0, proto_1.createMsgSubmitProposal)(params.content, params.initialDepositDenom, params.initialDepositAmount, sender.accountAddress);
...
exports.createTxMsgSubmitProposal = createTxMsgSubmitProposal;
