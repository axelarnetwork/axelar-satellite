...
exports.createTxMsgUpdateRevenue = void 0;
const proto_1 = require("@evmos/proto");
const eip712_1 = require("@evmos/eip712");
function createTxMsgUpdateRevenue(chain, sender, fee, memo, params) {
    const feeObject = (0, eip712_1.generateFee)(fee.amount, fee.denom, fee.gas, sender.accountAddress);
    const types = (0, eip712_1.generateTypes)(eip712_1.MSG_UPDATE_REVENUE_TYPES);
    const msg = (0, eip712_1.createMsgUpdateRevenue)(params.contractAddress, params.deployerAddress, params.withdrawerAddress);
    ...
    const msgCosmos = (0, proto_1.createMsgUpdateRevenue)(params.contractAddress, params.deployerAddress, params.withdrawerAddress);
...
exports.createTxMsgUpdateRevenue = createTxMsgUpdateRevenue;
