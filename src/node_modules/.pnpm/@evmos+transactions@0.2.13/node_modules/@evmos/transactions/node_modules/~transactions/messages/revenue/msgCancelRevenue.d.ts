...
export declare function createTxMsgCancelRevenue(chain: Chain, sender: Sender, fee: Fee, memo: string, params: MessageMsgCancelRevenue): {
    signDirect: {
...
//# sourceMappingURL=msgCancelRevenue.d.ts.map