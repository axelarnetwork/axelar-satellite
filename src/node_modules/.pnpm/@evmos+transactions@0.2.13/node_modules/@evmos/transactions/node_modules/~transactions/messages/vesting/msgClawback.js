...
exports.createTxMsgClawback = void 0;
const proto_1 = require("@evmos/proto");
const eip712_1 = require("@evmos/eip712");
function createTxMsgClawback(chain, sender, fee, memo, params) {
    const feeObject = (0, eip712_1.generateFee)(fee.amount, fee.denom, fee.gas, sender.accountAddress);
    const types = (0, eip712_1.generateTypes)(eip712_1.MSG_CLAWBACK);
    const msg = (0, eip712_1.createMsgClawback)(params.funderAddress, params.accountAddress, params.destAddress);
    ...
    const msgCosmos = (0, proto_1.createMsgClawback)(params.funderAddress, params.accountAddress, params.destAddress);
...
exports.createTxMsgClawback = createTxMsgClawback;
